...
public class WalletTransactionCell extends LinearLayout {
    ...
    public WalletTransactionCell(Context context) {
        ...
        encryptedImageView.setImageResource(R.drawable.permission_locked);
...
//    public void setTransaction(WalletDataSerializer.Transaction walletTransaction, boolean divider) {
