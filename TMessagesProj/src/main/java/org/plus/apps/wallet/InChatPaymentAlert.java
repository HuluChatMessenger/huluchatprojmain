...
public class InChatPaymentAlert extends BottomSheet{
    ...
    public InChatPaymentAlert(Context context, boolean needFocus) {
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                int contentSize = AndroidUtilities.dp(42) +   AndroidUtilities.dp(103) + backgroundPaddingTop;
        ...
        containerView.addView(gridView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 100, Gravity.TOP | Gravity.LEFT, 0, 8, 0, 0));
