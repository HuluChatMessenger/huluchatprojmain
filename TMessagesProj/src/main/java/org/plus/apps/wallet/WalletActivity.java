...
//import org.plus.apps.wallet.cells.WalletTransactionCell;
...
//
//    private Runnable shortPollRunnable = this::refreshWallet;
//
...
//        }
//        loadingWallet = true;
//        WalletController.getInstance(currentAccount).loadWallet();
//       // WalletController.getInstance(currentAccount).loadTransaction(classGuid,null);
//    }
//
//
//    @Override
...
//                    CameraScanActivity.showAsSheet(WalletActivity.this, false, new CameraScanActivity.CameraScanActivityDelegate() {
//                        @Override
...
//            boolean loaded = (boolean)args[0];
//            if(loaded){
//                transactions = (ArrayList<WalletDataSerializer.Transaction>)args[1];
//                parseTransaction();
//                if(adapter != null){
//                    adapter.notifyDataSetChanged();
//                }
...
//            WalletDataSerializer.Transaction transaction = transactions.get(a);
//            String monthKey  =  WalletController.getDateKey(transaction.created_at);
...
//            }
//            sectionArrays.put(monthKey, transactions);
//        }
//    }
//
...
//    }
//
//    private void updateTime(boolean schdule) {
...
//                    }else  if(position == transaction_fee){
//                       // textSettingsCell.setTextAndValue("Fee", transaction.transaction_fee + "%",true);
...
//        walletActionSheet = new WalletActionSheet(WalletActivity.this, WalletActionSheet.TYPE_SEND, user,null,true);
...
//            return;
//        }
//        switch (WalletController.getInstance(currentAccount).getKeyProtectionType()) {
//            case WalletController.KEY_PROTECTION_TYPE_LOCKSCREEN: {
...
//                break;
//            }
//            case WalletController.KEY_PROTECTION_TYPE_BIOMETRIC: {
//
////                biometricPromtHelper.promtWithCipher(WalletController.getInstance(currentAccount).getCipherForDecrypt(), LocaleController.getString("WalletDecryptConfirmCredentials", R.string.WalletDecryptConfirmCredentials), (cipher) ->
////                        getTonController().fillMemInputKey(null, cipher, () -> {
////                    if (adapter != null) {
////                        adapter.notifyDataSetChanged();
////                    }
////                }, null));
//                break;
//            }
//            case WalletController.KEY_PROTECTION_TYPE_NONE: {
...
//
//
//    private void showDepositAlert(WalletDataSerializer.PaymentProvider provider){
//
//
//    }
//
//    private AlertDialog alertDialog;
//    private void deposit(WalletDataSerializer.PaymentProvider provider,int amount,String phone){
//
//        try{
//            if(provider.key.equals("hello_cash")){
//                JSONObject object = new JSONObject();
//                object.put("provider",provider.key);
//                object.put("amount",amount);
//                JSONObject payload = new JSONObject();
//                payload.put("phone","+" + phone);
//                object.put("payload",amount);
//                alertDialog = new AlertDialog(getParentActivity(),3);
//                alertDialog.setCanCacnel(false);
//                showDialog(alertDialog);
////                getWalletController().depositToWallet(object, (response, error) -> AndroidUtilities.runOnUIThread(new Runnable() {
////                    @Override
////                    public void run() {
////                        if(alertDialog != null){
////                            alertDialog.cancel();
...
//                    if(wallet != null){
//                        balanceCell.setBalance(wallet.fixable);
//                    }else{
...
//                }
//                case 1: {
//                   // WalletTransactionCell transactionView = (WalletTransactionCell)holder.itemView;
//
