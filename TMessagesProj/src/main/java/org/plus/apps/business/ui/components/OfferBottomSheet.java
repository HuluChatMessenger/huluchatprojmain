...
public class OfferBottomSheet extends BottomSheet{
    ...
    public OfferBottomSheet(BaseFragment fragment, String comment) {
...
//            }
    ...
    public OfferBottomSheet(Context context, boolean needFocus) {
