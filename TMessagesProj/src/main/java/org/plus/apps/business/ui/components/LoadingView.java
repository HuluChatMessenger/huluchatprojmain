...
public class LoadingView extends View {
    ...
    public final static int FEATURED_SHOP = 8;
    public final static int BUSINESS_CONTAINER_TYPE = 6;
    public final static int BANNER_TYPE = 7;
    public final static int PRODUCT_TYPE = 9;
    public final static int PRODUCT_HORIZONTAL = 10;
    ...
    public void setFeedHeight(int feedHeight) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.color1 != color1 || this.color0 != color0) {
         ...
         if(getViewType() == feed){
             rectF.set(AndroidUtilities.dp(0), AndroidUtilities.dp(0),getMeasuredWidth() , getMeasuredWidth());
             canvas.drawRoundRect(rectF, AndroidUtilities.dp(16), AndroidUtilities.dp(16), paint);
         }else if(getViewType() == PRODUCT_TYPE){
            rectF.set(AndroidUtilities.dp(8), AndroidUtilities.dp(8), AndroidUtilities.dp(180), AndroidUtilities.dp(30));
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(4), AndroidUtilities.dp(4), paint);
            checkRtl(rectF);
            rectF.set(getMeasuredWidth() - AndroidUtilities.dp(80), AndroidUtilities.dp(8), getMeasuredWidth() - AndroidUtilities.dp(8), AndroidUtilities.dp(30));
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(4), AndroidUtilities.dp(4), paint);
            checkRtl(rectF);

            int photoWidth = (getMeasuredWidth() - (AndroidUtilities.dp(8) * (getColumnsCount() - 1))) / getColumnsCount();
            int h = 180;
            while (h < getMeasuredHeight()) {
                for (int i = 0; i < getColumnsCount(); i++) {
                    int x = i * (photoWidth + AndroidUtilities.dp(8));
                    // canvas.drawRect(x, h, x + photoWidth, h + photoWidth, paint);
                    rectF.set(x,h,x + photoWidth,h + photoWidth);
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(16), AndroidUtilities.dp(16), paint);

                }
                h += photoWidth + AndroidUtilities.dp(16);
                if (isSingleCell) {
                    break;
                }
            }

        }else if(getViewType() == PRODUCT_HORIZONTAL){
            rectF.set(AndroidUtilities.dp(8), AndroidUtilities.dp(8), AndroidUtilities.dp(180), AndroidUtilities.dp(30));
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(4), AndroidUtilities.dp(4), paint);
            checkRtl(rectF);
            rectF.set(getMeasuredWidth() - AndroidUtilities.dp(80), AndroidUtilities.dp(8), getMeasuredWidth() - AndroidUtilities.dp(8), AndroidUtilities.dp(30));
            ...
            int h = 0;
            while (h < getMeasuredHeight()) {
                int r = AndroidUtilities.dp(36);

                for (int i = 0; i < getColumnsCount(); i++) {
                    int x = i * (photoWidth + AndroidUtilities.dp(2));
                    canvas.drawCircle(checkRtl(AndroidUtilities.dp(8 ) + r) + x ,  (AndroidUtilities.dp(78 + 36)), r, paint);
        ...
        }else if(getViewType() == BANNER_TYPE){
            rectF.set(AndroidUtilities.dp(4), AndroidUtilities.dp(8),getMeasuredWidth() - AndroidUtilities.dp(4),  AndroidUtilities.dp(216));
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(16), AndroidUtilities.dp(16), paint);

        }else if (getViewType() == BUSINESS_CONTAINER_TYPE) {

            int w = 0;
            rectF.set(AndroidUtilities.dp(16), w + AndroidUtilities.dp(16), AndroidUtilities.dp(180), w + AndroidUtilities.dp(50));
            checkRtl(rectF);
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(4), AndroidUtilities.dp(4), paint);

            while (w < getMeasuredWidth()) {
                int r = AndroidUtilities.dp(43);
                canvas.drawCircle(checkRtl(AndroidUtilities.dp(8 ) + r) + w ,  (AndroidUtilities.dp(78 + 43)), r, paint);
                w += AndroidUtilities.dp(8 ) + r + w;
            }
    ...
    private int getCellHeight() {
        ...
        }else if(getViewType() == FEATURED_SHOP){
            return AndroidUtilities.dp(78) + 1;
        }
        return 0;
    }
