 ...
 * </p>
 */
public class SwipeRefreshNestedFrameLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private static final String LOG_TAG = SwipeRefreshNestedFrameLayout.class.getSimpleName();
     ...
     * @param context
     */
    public SwipeRefreshNestedFrameLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshNestedFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull SwipeRefreshNestedFrameLayout parent, @Nullable View child);
    }
