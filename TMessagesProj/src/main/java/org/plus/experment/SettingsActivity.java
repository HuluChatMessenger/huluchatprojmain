...
//
//    private TLRPC.ChatFull userInfo;
//
...
//                builder1.setTitle(LocaleController.getString("AppNameHulu", R.string.AppNameHulu));
...
//    retrofit2.Call<ResponseBody> geoEncode(@Query("latlng") String lat_long, @Query("key") String apiKey);
//}
//
//    public void encodeGpsLocation(TLRPC.GeoPoint point) {
//        if (point == null) {
//            return;
//        }
...
//                .build();
//
//        requestManagerQueue.postRunnable(() -> {
//            try {
//
//                MapInterface newInterface = newRetro.create(MapInterface.class);
//                String loc = point.lat + "," + point._long;
//                retrofit2.Response<ResponseBody> response = newInterface.geoEncode(loc, PlusBuildVars.GOOGLE_MAP_API).execute();
//                if (response.isSuccessful() && response.body() != null) {
//
//                    JSONObject object = new JSONObject(response.body().string());
//                    Type type = new TypeToken<ArrayList<LocResult>>() {
//                    }.getType();
//                    ArrayList<LocResult> locResults = gson.fromJson(object.getJSONArray("results").toString(), type);
//                    AndroidUtilities.runOnUIThread(() -> NotificationCenter.getInstance(currentAccount).postNotificationName(NotificationCenter.didLoadedTypeObject, true, LOADED_TYPE_LOC_RESULT, locResults));
//                }
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
