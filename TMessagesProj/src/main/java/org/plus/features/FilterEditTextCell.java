...
public class FilterEditTextCell extends FrameLayout {
    ...
    public FilterEditTextCell(Context context, OnClickListener onDelete) {
        this(context, false, onDelete);
    }

    //plus
    public FilterEditTextCell(Context context, boolean caption, OnClickListener onDelete, boolean tesf) {
        super(context);
        ...
        if (onDelete != null) {
            addView(textView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.CENTER_VERTICAL, LocaleController.isRTL ? 58 : 14, 0, !LocaleController.isRTL ? 58 : 14, 0));
            ...
            checkBox.setOnClickListener(v -> {
                ...
                onCheckBoxClick(FilterEditTextCell.this, !checkBox.isChecked());
            });
        } else {
    ...
    public FilterEditTextCell(Context context, boolean caption, OnClickListener onDelete) {
        super(context);
    ...
    //plus
    public void setMoveImageView(int resId) {
        moveImageView.setVisibility(GONE);
        deleteImageView.setImageResource(resId);
    }
    ...
    protected void onCheckBoxClick(FilterEditTextCell editText, boolean checked) {
        checkBox.setChecked(checked, true);
    }

    protected boolean isChecked(FilterEditTextCell editText) {
        return false;
    }
