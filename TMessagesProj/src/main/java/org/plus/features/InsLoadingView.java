...
public class InsLoadingView extends BackupImageView {
    ...
    public InsLoadingView(Context context) {
        super(context);
        //setStartColor(Color.YELLOW);
        //setEndColor(Color.BLUE);
        mCircleDuration = 2000;
        mRotateDuration = 1000;
        setStatus(sStatusArray.get(2));
        onCreateAnimators();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = AndroidUtilities.dp(100);
