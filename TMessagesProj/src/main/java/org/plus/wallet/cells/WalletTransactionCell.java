...
//        encryptedImageView.setImageResource(R.drawable.ic_lock_white);
...
//
//
//    public WalletModel.Transaction getCurrentTransaction() {
//        return currentTransaction;
//    }
//
//    protected void updateRowWithTransaction(WalletModel.Transaction transaction) {
//
//    }
//
//   public void setTransaction(WalletModel.Transaction  transaction, boolean divider) {
//
...
//            text = String.format("+%s", WalletUtils.formatCurrency(value));
//        }
//
//
//
//   }
//
////    public void setTransaction(WalletModel.Transaction  walletTransaction, boolean divider) {
